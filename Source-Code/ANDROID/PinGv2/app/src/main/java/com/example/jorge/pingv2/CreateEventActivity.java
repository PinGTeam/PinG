...
public class CreateEventActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            selectedStartTime = (TextView) findViewById(R.id.eventStartInput);
            ...
            selectedEndTime = (TextView) findViewById(R.id.eventEndInput);
        ...
        public void showSetTimeDialog(final int whichField) {
            SetTimeDialog timeDialog = SetTimeDialog.newInstance(new SetTimeDialog.SetTimeDialogListener() {
                ...
                public void onDialogPositiveClick(int hour, int minute) {
                    ...
                    if(whichField == 1) {
                        timeView = (TextView) findViewById(R.id.eventStartInput);
                        ...
                        timeView = (TextView) findViewById(R.id.eventEndInput);
